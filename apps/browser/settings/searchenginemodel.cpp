...
const auto SEARCH_ENGINE_CONFIG = QStringLiteral("/apps/sailfish-browser-next153/settings/search_engine");
const auto SEARCH_ENGINES_AVAILABLE_CONFIG = QStringLiteral("/apps/sailfish-browser-next153/settings/search_engines_available");
