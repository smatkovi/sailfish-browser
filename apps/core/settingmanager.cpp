...
{
    m_searchEngineConfItem = new MDConfItem("/apps/sailfish-browser-next/settings/search_engine", this);
    connect(m_searchEngineConfItem, &MDConfItem::valueChanged,
            this, &SettingManager::setSearchEngine);

    // Look and feel related settings
    m_toolbarSmall = new MDConfItem("/apps/sailfish-browser-next/settings/toolbar_small", this);
    m_toolbarLarge = new MDConfItem("/apps/sailfish-browser-next/settings/toolbar_large", this);
