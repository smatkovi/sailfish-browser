...
DeclarativeWebUtils::DeclarativeWebUtils()
    : QObject()
    , m_homePage(new MDConfItem("/apps/sailfish-browser-next153/settings/home_page", this))
{
...
void DeclarativeWebUtils::updateWebEngineSettings()
{
    ...
    webEngineSettings->setPreference(QStringLiteral("general.useragent.updates.enabled"),
                        MDConfItem(QStringLiteral("/apps/sailfish-browser-next153/settings/useragent_update_enabled")).value(QVariant(true)));
    webEngineSettings->setPreference(QStringLiteral("general.useragent.updates.url"),
                        MDConfItem(QStringLiteral("/apps/sailfish-browser-next153/settings/useragent_update_url")).value(defaultUserAgentUpdateUrl));
    webEngineSettings->setPreference(QStringLiteral("general.useragent.updates.interval"),
                        MDConfItem(QStringLiteral("/apps/sailfish-browser-next153/settings/useragent_update_interval")).value(QVariant(172800))); // every 2nd day
    webEngineSettings->setPreference(QStringLiteral("general.useragent.updates.retry"),
                        MDConfItem(QStringLiteral("/apps/sailfish-browser-next153/settings/useragent_update_retry")).value(QVariant(86400))); // 1 day
