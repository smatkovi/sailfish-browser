...
const auto MOZILLA_DATA_UA_UPDATE_SOURCE = QStringLiteral("/usr/share/sailfish-browser-next153/data/ua-update.json.in");
const auto MOZILLA_DATA_PREFS = QStringLiteral("prefs.js");
const auto MOZILLA_DATA_PREFS_SOURCE = QStringLiteral("/usr/share/sailfish-browser-next153/data/prefs.js");
