...
testdata.path = /opt/tests/sailfish-browser-next153/manual/

testnavigationdata.files = navigation/*.html
testnavigationdata.path = /opt/tests/sailfish-browser-next153/manual/navigation/

# .desktop file used for functional testing
testdesktop.files = test-sailfish-browser-next153.desktop
